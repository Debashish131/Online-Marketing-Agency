...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="OMA">
...
<div class="page-wrapper">
            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="/home" class="logo">
                        <img src="assets/images/demos/demo-18/logo.png" alt="OMA" width="105" height="25">
                    </a>
    ...
    <main class="main">
        <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">All Packages<span>Details</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Showing
                                    <span>{{$count = \App\Product::all()->count()}} of  {{$count = \App\Product::all()->count()}}</span>
                                    Packages
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action-vertical">
                                                    <form action="/wishList{{$val->id}}" method="POST">
                                                        ...
                                                        <button class="btn-product-icon btn-wishlist btn-expandable">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product.html">Facebook Marketing</a>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="#">How to BUY on OMA</a></li>
                                <li><a href="#">FAQ</a></li>

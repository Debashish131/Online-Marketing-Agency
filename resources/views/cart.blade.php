                            ...
                            <div class="header-left">
                                ...
                                <nav class="main-nav">
                                    <ul class="menu sf-arrows">
                                        ...
                                        <li>
                                            <a href="/product" class="sf-with-ul">Packages</a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9">
                            <table class="table table-cart table-mobile">
                                ...
                                <tr>
                                    ...
                                    <td class="total-col">{{$product->product_price}} $</td>
                                    <td class="remove-col">
                        ...
                        <aside class="col-lg-3">
                            ...
                            <a href="/productCategory" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i
                                    class="icon-refresh"></i></a>
                        </aside><!-- End .col-lg-3 -->
                    </div><!-- End .row -->
                </div><!-- End .container -->

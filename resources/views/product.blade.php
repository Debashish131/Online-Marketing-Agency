...
<head>
    ...
    <meta name="description" content="Online Marketing Agency">
                ...
                <div class="header-left">
                    ...
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            <li>
                                <a href="/productCategory" class="sf-with-ul">Packages</a>
                            </li>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="product-details product-details-centered">
                                ...
                                <div class="details-filter-row details-row-size">
                                    <label for="size">Pack:</label>
                                    <div class="select-custom">
                                        <select name="size" id="size" class="form-control">
                                            <option value="#" selected="selected">One</option>
                                            <option value="s">Monthly</option>
                                            <option value="m">Yearly</option>
                                        </select>
                                    </div><!-- End .select-custom -->

                                    <a href="#" class="size-guide"><i class="icon-th-list"></i>Package Type</a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                ...
                                <p>Our online small business marketing packages are designed to help you outsource your
                                    marketing activities to a
                                    team that has the skills needed to create an impact in the marketplace. With the
                                    rapidly changing online marketing
                                    landscape, working with an outsourced marketing department helps you
                                    implement the marketing your business needs while you continue to focus on running
                                    the business. </p>
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget widget-about">
                            <img src="assets/images/demos/demo-18/logo-icon.png" alt="OMA" width="105" height="25">
